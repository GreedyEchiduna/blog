...
`data/authors` - [全部作者信息配置文件夹](data/authors)
`data/authors/default.md` - [默认发布作者信息配置文件](data/authors/default.md)

// TODO 干嘛的
`data/projectsData.js` - data used to generate styled card on the projects page.

`data/headerNavLinks.js` - [标题栏右侧导航链接](data/headerNavLinks.js)

`data/logo.svg` - [网站 LOGO](data/logo.svg)

`data/blog` - [博文文件夹](data/blog/)

`public/static` - [静态文件文件夹,储存站内图片和图标](public/static)
